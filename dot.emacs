...
(custom-set-variables
 ...
 '(package-selected-packages
   '(yasnippet yaml-mode use-package solarized-theme sbt-mode projectile magit-todos magit-org-todos magit-gh-pulls lsp-ui lsp-metals json-mode js3-mode flycheck exec-path-from-shell company ag)))
(custom-set-faces
